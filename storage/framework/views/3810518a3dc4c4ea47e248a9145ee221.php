      ...
      <div class="container text-center text-md-start mt-5">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <p>
              <a href="<?php echo e(route('product')); ?>" class="text-reset">Product</a>
            </p>
            <p>
              <a href="<?php echo e(route('about.index')); ?>" class="text-reset">About</a>
            </p>
            <p>
              <a href="<?php echo e(route('contact.index')); ?>" class="text-reset">Contact Us</a>
            </p>
          </div>
...
</html><?php /**PATH G:\example-app\resources\views/footer.blade.php ENDPATH**/ ?>